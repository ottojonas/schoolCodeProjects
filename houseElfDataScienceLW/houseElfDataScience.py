...
with open("grangers_analysis.csv", "w", newline="") as file:
    ...
    for elfID, size, dna in data:
        ...
        writer.writerow([elfID, size, f"{cgContent:.2f}%"])

# *output of average cg content in all elves
print(
    f"there was an average of {totalCharDNA / cgContent:.2f} C and G charaters in the elves DNA"
)
